...
class StrainsControllerTest < ActionController::TestCase
  ...
  test "should create strain" do
    assert_difference('Strain.count') do
      post :create, strain: { contig_num: @strain.contig_num, genus: @strain.genus, length: @strain.length, name: @strain.name, species: @strain.species }
    end
  ...
  test "should update strain" do
    patch :update, id: @strain, strain: { contig_num: @strain.contig_num, genus: @strain.genus, length: @strain.length, name: @strain.name, species: @strain.species }
    assert_redirected_to strain_path(assigns(:strain))
  end
